...
The followings are taken from the README.txt which was included in the “getdata_projectfiles_UCI HAR Dataset.zip” file.
...
4.	Appropriately labels the given data set from the original collectors with more descriptive variable names
5.	Create a tidy data set from the intermediate data set
